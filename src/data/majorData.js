...
export const benkeMajorNames = new Set([
  ...
  '护理学',
  '助产学',
  // 条件④：职业本科更名前的原专业名，在普通本科目录中存在同名，也应符合
  '商务英语',
  '健康服务与管理',
])
...
// ==================== 自考旧专业名称 → 新专业名称映射 ====================
// 用户输入旧专业名 → 查找对应新专业名 → 用新专业名走777表判断

// 自考本科旧名称映射（83个）
export const zkBenkeOldNameMap = {
  '中药学': '中药学',
  '体育教育': '体育教育',
  '信息与计算科学': '计算机科学与技术',
  '信息安全': '信息安全',
  ...
  '教育管理': '教育管理*',
  '数字媒体技术': '数字媒体技术',
  '数控加工与模具设计': '机械设计制造及其自动化',
  '数控技术': '机械设计制造及其自动化',
  '机械制造及自动化': '机械设计制造及其自动化',
  '机械电子工程': '机械电子工程',
...
// 自考专科旧名称映射（99个）
export const zkZhuankeOldNameMap = {
  '中医推拿按摩': '康复治疗技术',
  '中药制药技术': '中药学',
  '中药学': '中药学',
  '俄语': '应用俄语',
